                            ...
                            <div class="row">
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" min="1" class="form-control @error('period') is-invalid @enderror" name="period" value="{{ old('period', 1) }}" placeholder="Jangka Waktu (Bulan)">
                                        <span class="error invalid-feedback">{{ $errors->first('period') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label>Nominal Angsuran (Rp)</label>
                                        <input type="number" min="0" class="form-control @error('installment') is-invalid @enderror" name="installment" value="{{ old('installment', 0) }}" placeholder="Nominal Angsuran">
                                        <span class="error invalid-feedback">{{ $errors->first('installment') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label>Nominal Pengembalian (Rp)</label>
                                        <input type="number" min="0" class="form-control @error('return_amount') is-invalid @enderror" name="return_amount" value="{{ old('return_amount', 0) }}" placeholder="Nominal Pengembalian">
